...
public class Teste {
	...
	public void test() {
		...
		modelo.cadastrarUsuario(new Usuario("Jose_Ricardo","12345","josericardo@email.com","K2033J", new Saldo("K2033J", 100.0), new Conta(25.00,123456,false, LocalDate.of(17,11,16))));
		...
		//assertEquals(modelo.isLate(LocalDate.of(2017, 11, 17)),false);
		//assertEquals(modelo.isLate(LocalDate.of(2017, 11, 15)),false);
